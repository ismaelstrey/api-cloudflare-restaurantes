...
export function createFileRoutes(db: DatabaseClient, r2Bucket: R2Bucket, baseUrl: string = '') {
  ...
  fileRoutes.get(
    '/download/:key',
    async (c) => await fileController.downloadFile(c)
  );
  ...
  fileRoutes.get(
    '/view/:key',
    async (c) => await fileController.viewFile(c)
  );
  ...
  fileRoutes.get(
    '/list',
    async (c) => await fileController.listFiles(c)
  );
  ...
  fileRoutes.get(
    '/info/:id',
    async (c) => await fileController.getFileInfo(c)
  );
  ...
  fileRoutes.delete(
    '/delete/:id',
    async (c) => await fileController.deleteFile(c)
  );
  ...
  fileRoutes.get(
    '/stats',
    async (c) => await fileController.getStorageStats(c)
  );
