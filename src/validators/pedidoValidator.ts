...
export const createPedidoSchema = z.object({
  ...
  }).min(2, 'Nome do cliente deve ter pelo menos 2 caracteres').max(100, 'Nome do cliente deve ter no máximo 100 caracteres'),
  ...
  }).positive('Preço deve ser maior que zero').max(999.99, 'Preço deve ser menor que R$ 999,99'),
});
...
export const updatePedidoSchema = z.object({
  cliente: z.string().min(2, 'Nome do cliente deve ter pelo menos 2 caracteres').max(100, 'Nome do cliente deve ter no máximo 100 caracteres').optional(),
  ...
  preco: z.number({
    invalid_type_error: 'Preço deve ser um número',
  }).positive('Preço deve ser maior que zero').max(999.99, 'Preço deve ser menor que R$ 999,99').optional(),
